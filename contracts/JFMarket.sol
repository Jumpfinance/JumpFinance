...
import "./interface/external/IJF.sol";
...
contract JFMarket is IJFMarket, PriceManager {
    ...
    event NewJF(IJF oldJF, IJF newJF);
    ...
    function initialize(IJF jf_) public {
    ...
    function publishFixedPrice(
        ...
        uint256 err = IJF.publishFixedPriceAllowed(
            icToken_,
            tokenId_,
            seller,
            currency_,
    ...
    function publishDecliningPrice(
        ...
        uint256 err = jf.publishDecliningPriceAllowed(
            vars.icToken,
            vars.tokenId,
            vars.seller,
            vars.currency,
    ...
    function _setJF(IJF newJF_) public virtual onlyAdmin {
        IJF oldJf = JF;
        require(newJF_.isJF(), "invalid jf");
        jf = newJF_;

        emit NewJF(oldJF, newJF_);
    }
